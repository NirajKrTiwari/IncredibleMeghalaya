        ...
        <div className={css.container} id="about">
            ...
            <div className={css.contain}>
                <div className={css.info}>
                    <p>
                    Welcome to the About Us page of our tourism website, where we are pleased to introduce you to the magical and diverse state of Meghalaya in India. At Meghalaya Tourism, we are passionate about promoting and showcasing the natural beauty, cultural richness, and adventure experiences that Meghalaya has to offer. Our goal is to help you discover the hidden gems of this charming state and make your trip unforgettable.<br></br><br></br>
